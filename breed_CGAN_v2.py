...
# version 2 of the Breed Generator, used label at the begining of the input, model is too large
# first edition of using deep convolution network
...
def loadData(image_path):
    ...
    true_dogs = torchvision.datasets.ImageFolder( image_path,
                    transform = transforms.Compose( [transforms.Resize(64),
                                                    ...
                                                    transforms.ToTensor(),
                                                    transforms.Normalize((0.5,0.5,0.5), (1,1,1)) #mean being 0.5
                                                    ] ) )
...
class DiscriminatorModel(nn.Module):
    def __init__(self):
        ...
        input_dim = 12288 + 20 #+20 is the embeding
